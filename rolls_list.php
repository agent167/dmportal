...
$sql2="DELETE FROM rolls_in_pages WHERE ROLLID = $del";

		if(!mysqli_query($link, $sql2)){
		echo "ERROR: Could not able to execute $sql2. " . mysqli_error($link);
	}
		
$sql="DELETE FROM rolls_ms WHERE ID = $del";
...
if (isset($_REQUEST['actc']))
{
	...
	{
		$sql="UPDATE rolls_ms SET STATUS='1' WHERE ID=$RID ";
	}
	else if ($_REQUEST['actc']=='unapp')
	{
		$sql="UPDATE rolls_ms SET STATUS='0' WHERE ID=$RID ";
	}
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Add Roll Details</h4>
      </div>
      ...
      <div class="modal-footer">
        ...
        <div class="container body">
            <div class="main_container">
        		...
        		<tbody>
                <?php
                	$result = mysqli_query($link, "SELECT * FROM rolls_ms ORDER BY ROLLNAME");
				...
				?>
        			<tr>
        				...
        				<td data-title="Action" class="al-center">
                            ...
                            <a href="rolls_edit.php?id=<?php echo $ID; ?>" data-toggle="tooltip" data-placement="top" title="Edit" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i></a>
