                            ...
                            <div class="x_panel">
                                <div class="x_title">
                                    ...
                                    <ul class="nav navbar-right panel_toolbox">
                                        ...
                                        <!-- <li>
                                            <a href="countries_add.php?type=2" class="border-none btn btn-primary btn-xs bg-none">
                                            ...
                                            ?>
                                                <tr id="">
                                                    ...
                                                    <td data-title="Action" class="al-center">
                                                        <?php
                                                        ?>
                                                        <a href="currencies_banner_download.php?id=<?php echo $cc_id . "&country_id=" . $country_id; ?>" data-toggle="tooltip" data-placement="top" title="Download" class="btn btn-success btn-sm"><i class="fa fa-download"></i></a>
                                                        ...
                                                        <?php
                                                        $check_banner_sending_types = mysqli_num_rows(mysqli_query($link, "SELECT * FROM `banners` WHERE `count_curr_id`='$cc_id' AND  `type` IN (1,5,7)"));
                                                        if ($check_banner_sending_types == 0) {
                                                        ?>
                                                            <a href="<?php echo basename($_SERVER['PHP_SELF']) . "?id=" . $cc_id;
                                                                        ?>&delete=y" onclick="javascript:return confirm('Are you sure you want to delete ?')" data-toggle="tooltip" data-placement="top" title="Delete" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></a>
                                                    </td>
                                                </tr>
                                        <?php 
                                        }
