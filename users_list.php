      ...
      <div class="modal-footer">
        ...
        <div class="container body">
            <div class="main_container">
        		...
        		<tbody>
                <?php
                	$result = mysqli_query($link, "SELECT * FROM admin ORDER BY FRMUSERID");
				...
				?>
        			<tr>
						...
						<?php
                        	if ($USERCAT==0) { echo '<i class="fa fa-shield text-primary"></i>';}
						?>
        				...
        				<td data-title="Status" class="al-center">
                        	...
                        	<?php
                        		if ($USERCAT==0) {
							?>
                        	<span class="btn btn-primary btn-xs">Active</span>
                            <?php
							}
							else {
							?>
        				...
        				<td data-title="Action" class="al-center">
                            ...
                            <a href="users_edit.php?id=<?php echo $ID; ?>" data-toggle="tooltip" data-placement="top" title="Edit" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i></a>
