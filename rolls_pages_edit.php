...
<?php
$RID = $_GET['id'];
	$result = mysqli_query($link, "SELECT * FROM `rolls_ms_pages` WHERE ID='$RID'");
...
$sql="UPDATE `rolls_ms_pages` SET PAGENAME='$PAGENAME', PAGEURL='$PAGEURL', STATUS='$STATUS' WHERE ID = '$RID'";
