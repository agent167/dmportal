...
function init_sidebar() {
    ...
    $MENU_TOGGLE.on('click', function () {
        ...
        if ($BODY.hasClass('nav-md')) {
            ...
            document.getElementById('f-logo').style.display = 'none';
            document.getElementById('l-icon').style.display = 'inline-block';
        } else {
            $SIDEBAR_MENU.find('li.active-sm ul').show();
            $SIDEBAR_MENU.find('li.active-sm').addClass('active').removeClass('active-sm');
            $(".breadcrumb_content").removeAttr('style');
            document.getElementById('f-logo').style.display = 'inline-block';
            document.getElementById('l-icon').style.display = 'none';
        }
