...
if (isset($_GET['delete']) && $_GET['delete'] == 'y') {
    $cc_id = $_GET['id'];
    $delid = $_GET['delid'];                         // added by umair naveed
    $banner_type = $_GET['banner_type'];
    banner_delete($link, $cc_id, $banner_type, $delid); //added by umair naveed
    // banner_delete($link, $cc_id, $banner_type, $del_id);
}
?>
<body class="nav-md">
    <style>
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    ...
                                    <?php } ?>
                                    <?php if (isset($_GET['failes5'])) { ?>
                                        <div class="alert alert-danger">
                                            <div class="container"><strong>File Size is too Big.</strong></div>
                                        </div>
                                    <?php }
                                    ...
                                    <div id="no-more-tables">
                                                    ...
                                                    <div class="conatnt_alignment">
                                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                                            ...
                                                            <select name="banner_sub_type" id="banner_sub_type" class="form-control" required>
                                                                ...
                                                                ?>
                                                                 <option value="<?php echo $banner_sub_type['id'] ?>"><?= ucfirst(str_replace("_"," ", $banner_sub_type['name']));?></option>
                                                                <?php
                                                                }
                                                                ?>
                                                            </select>
                                        ...
                                        <div class="row sml-padding" style="margin-top: 1%;">
                                            <div class="col-lg-12">
                                                <div class="row">
                                                    <h1 class="col-lg-10 offset-2 content_alignment"> 
                                            ...
                                            <br><br><br><br><br><br><br><br><br><br>
                                                <div class="row">
                                                    <h1 class="col-lg-10  offset-2 content_alignment"> Receiving Country Wise</h1>
                                                </div>
                                                <div class="row">
                                                    <div class=" col-lg-12 content_alignment">
                                                        <div class="content_alignment_inner_div">
